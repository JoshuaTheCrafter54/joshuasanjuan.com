...
// Load the default theme ('lightTheme') when the page is fully loaded
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add an event listener to toggle between light and dark themes
    themeToggle.addEventListener('change', () => {
        currentTheme = themeToggle.checked ? 'darkTheme' : 'lightTheme';
        setTheme(currentTheme);        
    });
});
